...
import getRelatedAuditActivityResources from '@salesforce/apex/cpAuditRelatedProducts.getRelatedAuditActivityResources';
...
export default class RecordRelatedListActivityResources extends LightningElement {
    @api recordId;
    @api objectApiName;
    ...
    @wire(getRelatedAuditActivityResources, {recordId : '$recordId'})
    relatedAuditActivityResources({ error, data }) {
        ...
        if (data) {
           console.log('getRelatedAAResources ', data);
            ...
            this.records =  resp;
            console.log('getRelatedAAResources' ,JSON.stringify(this.aaRelatedRecords));  
        } else if (error) {
